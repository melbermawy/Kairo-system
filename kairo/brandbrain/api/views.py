...
- GET /latest: <50ms (single indexed lookup)
...
def latest_snapshot(request, brand_id: str) -> JsonResponse:
    ...
    Supports ?include=full for verbose mode (evidence_status, qa_report).
    """
